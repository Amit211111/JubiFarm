...
public class PostPlantationPojo {
    private  String local_id ;
    private  String crop_type_catagory_id ;
    private  String post_plantation_id ;
    ...
    public String getPost_plantation_id() {
        return post_plantation_id;
    }

    public void setPost_plantation_id(String post_plantation_id) {
        this.post_plantation_id = post_plantation_id;
    }
    ...
    public static final String TABLE_NAME = "post_plantation";
    public static final String COLUMN_LOCAL_ID = "local_id";
    public static final String COLUMN_ID = "id";
    public static final String COLUMN_CROP_TYPE_CATAGORY_ID = "crop_type_catagory_id ";
    public static final String COLUMN_POST_PLANTATION = "post_plantation_id";
