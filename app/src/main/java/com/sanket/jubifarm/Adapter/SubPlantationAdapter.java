...
public class SubPlantationAdapter extends RecyclerView.Adapter<SubPlantationAdapter.ViewHolder> {

    ArrayList<SubPlantationPojo> arrayList;
    ArrayList<SubPlantationPojo> arrayList1;
    Context context;
    ...
    public SubPlantationAdapter(ArrayList<SubPlantationPojo> arrayList, Context context,ArrayList<SubPlantationPojo> arrayList1) {
    ...
    @NonNull
    @Override
    public SubPlantationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.sub_plantation_custom, parent, false);
        SubPlantationAdapter.ViewHolder viewholder = new SubPlantationAdapter.ViewHolder(view);
        return viewholder;
    }

    @Override
    public void onBindViewHolder(@NonNull SubPlantationAdapter.ViewHolder holder, int position) {
